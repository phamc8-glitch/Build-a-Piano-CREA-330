...
const catbutton_KEYS = ['shift'];

const whiteKeys = document.querySelectorAll('.key.white');
const blackKeys = document.querySelectorAll('.key.black');
const catbuttonKeys = document.querySelectorAll('.key.catbutton');
...
document.addEventListener('keydown', (e) => {
  ...
  const catbuttonKeyIndex = Catbutton_KEYS.indexOf(key);
...
if (catbuttonKeyIndex > -1) {
    playNote(catmeow[catbuttonKeyIndex]);
  }
